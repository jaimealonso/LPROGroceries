...
public class SSIM {
	...
	public static double getSimilarity(String path1, String path2){
		
		
		ImagePlus image_1_imp = IJ.openImage(path1);  //THIS PLUGIN WORKS WITH TWO (AND ONLY TWO) IMAGES OPEN IN IMAGEJ
		ImagePlus image_2_imp = IJ.openImage(path2);
		ImageProcessor image_1_p;
		ImageProcessor image_2_p;
